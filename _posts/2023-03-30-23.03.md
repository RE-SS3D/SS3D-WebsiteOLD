...
Since the game we are making is community-oriented, feel free to read up on our [Design page]({{ site.gitbook_url }}/design/) and share your thoughts on our Discord or GitHub.

Also, if you're curious about seeing our development progress in the form of a plan and where we are in that plan, see our [Roadmap page]({{ site.gitbook_url }}/dev-guide/roadmap).
...
- Created a [2D art guide]({{ site.gitbook_url }}/art-guide/2d) and added it to GitBook.
