...
Since the game we are making is community-oriented, feel free to read up on our [Design page](https://ss3d.gitbook.io/design/) and share your thoughts on our Discord or GitHub.

Also, if you're curious about seeing our development progress in the form of a plan and where we are in that plan, see our [roadmap page](https://ss3d.gitbook.io/dev-guide/roadmap).
...
- Fixed issue with clients not being able to join an editor-based server.
...
- Created a [2D art guide](https://ss3d.gitbook.io/art-guide/2d) and added it to GitBook.
...
{% responsive_image path: assets/img/SS3D.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/SS3Dsmall.png template: _includes/srcset.html %}
