...
{% responsive_image path: assets/img/posts/19.03.1/PosterKonstantin3001GAUSS.png alt: "GAUSS rifle poster" %}
</div>
<div class='horizontal-2' markdown='1'>
{% responsive_image path: assets/img/posts/19.03.1/PosterKonstantin3001JoinSyndie.png alt: "Join the Syndicate" %}
{% responsive_image path: assets/img/posts/19.03.1/PosterKonstantin3001NASAAirlock.png alt: "Outdated NASA airlock" %}
</div>
**Enclave**
...
**Fuu**
<div class='horizontal-3' markdown='1'>
{% responsive_image path: assets/img/posts/19.03.1/FuuShieldGenerator.png alt: "Shield generator" %}
{% responsive_image path: assets/img/posts/19.03.1/FuuParticleAccellorationationator.png alt: "Particle accelerator" %}
{% responsive_image path: assets/img/posts/19.03.1/FuuFieldProjector1.png alt: "Shield rojector" %}
</div>
<div class='horizontal-2' markdown='1'>
{% responsive_image path: assets/img/posts/19.03.1/FuuEmitter1.png alt: "Emitter1" %}
{% responsive_image path: assets/img/posts/19.03.1/FuuEmitter2.png alt: "Emitter2" %}
</div>
<div class='horizontal-3' markdown='1'>
{% responsive_image path: assets/img/posts/19.03.1/FuuSmokes.png alt: "Smokes" %}
{% responsive_image path: assets/img/posts/19.03.1/FuuMopSquirtDisk.png alt: "MopSquirtDisk" %}
{% responsive_image path: assets/img/posts/19.03.1/FuuEyeDropper.png alt: "Eyedrops" %}
</div>
{% responsive_image path: assets/img/posts/19.03.1/FuuJanitorCart.png template: _includes/srcset.html alt: "Stacking janitor cart" %}

**White Eagle**

{% responsive_image path: assets/img/posts/19.03.1/WhiteEagleJanitorSet1.png template: _includes/srcset.html alt: "Paint remover, light replacer, bear trap, janitor cart, mop" %}
<div class='horizontal-2' markdown='1'>
{% responsive_image path: assets/img/posts/19.03.1/WhiteEagleHoloProjector.png alt: "Janitor's Holo-projector" %}
{% responsive_image path: assets/img/posts/19.03.1/WhiteEagleTrapBoxSmokeBomb.png alt: "A box of mousetraps and a foamgrenade" %}
</div>
