...
Our important and newly installed gear being basic inventory, thanks to Nonanon! The system allows for picking up, placing, storing, and equiping of items. Objects can be placed on tables, on the floor, or even other objects. Switching hands can be done manually or with the 'X' key for those of you familiar with hotkey mode from TG SS13.
