...
*Disclaimer: SS3D is a top down game but the camera here is zoomed in to show more detail. And gravity is not implemented for the player yet, so just pretend you don't notice the player floating in this first clip.*
