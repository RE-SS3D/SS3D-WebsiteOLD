...
Our important newly installed gear being basic inventory, thanks to Nonanon! Which allows for picking up, placing, storing, and equiping of items. Objects can be placed on tables, on the floor, or even other objects. Switching hands can be done manually or with the 'X' key for those of you familiar with hotkey mode from TG SS13.
...
Moving items around in inventories can be done via clicking your desired locaiton or by clicking and then dragging your item to the location you want. Players currently have access to all body slots but clothing slots (belts, pockets, suits, ect.) are yet to be implemented. Items and item slots have rudimentary restrictions so that you can't equip meson goggles to your feet, for example; and slots will highlight if they are compatible with the item being equipped.
...
There is still quite a bit more to do, but these are all the basic necessities for the inventory of which a lot of other features can be started... so thanks again Nonanon!
...
More newly acquired modellers with skill seem to show up each month and this month was no exception...

From Bwoink this month we have the biogenerator, and the ripley mech!

{% responsive_image path: assets/img/posts/19.11.01/BwoinkBriogenerator.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/BwoinkMiniMech.png template: _includes/srcset.html %}

From Eiko, a crab and walking mushroom!

{% responsive_image path: assets/img/posts/19.11.01/EikoCrab.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/EikoWalkingMushroom.png template: _includes/srcset.html %}
...
{% responsive_image path: assets/img/posts/19.11.01/CosmicAirlocks1.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/CosmicAirlocks2.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/CosmicTables.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/CosmicWallPanels.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/CosmicOrangePlant.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/CosmicKillerTomato.png template: _includes/srcset.html %}

One of our new modelers, Divibee, has provided quite a collection this month including meson goggles, a multitool, the changlings's armblade, the chaplain's null set, glow shrooms, a buttbot and more!

{% responsive_image path: assets/img/posts/19.11.01/DiviMesonGoggles.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/DiviMultitool.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/DiviArmblade.png template: _includes/srcset.html %}
...
{% responsive_image path: assets/img/posts/19.11.01/DiviButtbot.png template: _includes/srcset.html %}
...
{% responsive_image path: assets/img/posts/19.11.01/GoaoSpacecarps.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/GoaoAnimals.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/GoaoGoldenWheelchair.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/GoaoDispensers.png template: _includes/srcset.html %}
...
{% responsive_image path: assets/img/posts/19.11.01/LiddiusMULEBot.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/LiddiusChefbot.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/LiddiusFlamethrower.png template: _includes/srcset.html %}

{% responsive_image path: assets/img/posts/19.11.01/LiddiusIonRifle.png template: _includes/srcset.html %}
