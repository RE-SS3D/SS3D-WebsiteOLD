...
Another really neat contribution, which has been in works for some time, are these job and stamp graphics from **Konstantin3001**.  Some of the jobs are used from the artist **Luis Prado** on [thenounproject.com](thenounproject.com), but many are unique recrafts by **Konstantin3001**
