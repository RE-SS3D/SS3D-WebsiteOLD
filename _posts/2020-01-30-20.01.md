...
If you don't want to download Unity and build the most recent development changes yourself, you can instead [**download our latest build (v0.3.0) here**]({{ site.github_game_url }}/releases/tag/0.3.0){:target="_blank"}, which has been updated recently. And we also hope to update it frequently by integrating automated builds in the future for each minor release.
