...
**Konstantin3001** continuing to provide 2D artwork, this month with a bunch of various separated graphics of which only *a few* are displayed here. Several of the organs are used from the artist **Jakob Vogel** on [thenounproject.com](thenounproject.com).
