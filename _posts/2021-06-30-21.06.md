...
June brought us several small fixes and quality of life features both in the game and outside of it. We added a new [discussions tab on github]({{ site.github_game_url }}/discussions){:target="_blank"} which we will begin hosting various community discussions. If you feel inclined you can even start your own discussion, like providing feedback, making a suggestion, or asking the community a question. 
